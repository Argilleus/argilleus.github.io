...
@import url('https://fonts.googleapis.com/css2?family=EB+Garamond:wght@400;600;700&family=Source+Sans+3:wght@300;400;600&display=swap');
...
:is(.btn, .download-btn, .browse-btn) {
...
/* Remove default disclosure triangle/arrow */
details summary {
...
h1 {
    margin: 0;
    font-family: var(--font-serif);
    font-size: clamp(2.5rem, 5vw + 1rem, 3.4rem);
    font-weight: 700;
    letter-spacing: 1px;
}
...
html.dark-mode {
    ...
    /* Warm dark paper & surface tones */
    --paper: #181715;
    --paper-dark: #24221f;
    --surface: #201f1c;
    
    /* Readable warm light text */
    --text: #e6e2d8;
    --text-muted: #a69f92;
    
    /* Warm brass/gold accent matching classic score aesthetic */
    --accent: #d4a359;
    --accent-light: #e5b872;
...
html.dark-mode :is(.btn, .download-btn, .browse-btn) {
    color: #181715;
    background-color: var(--accent);
